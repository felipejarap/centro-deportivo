#  Microservicio ms-reservas

Este microservicio gestiona el ciclo de vida completo de las reservas de los deportistas. Implementa un **CRUD completo** y sigue una arquitectura de capas profesional.
...
###  Gestión de Entrenadores (`/reservas`)

| Método     | Endpoint | Descripción                            |
|:-----------| :--- |:---------------------------------------|
| **GET**    | `/api/v1/reservas` | Listar todas las reservas              |
| **GET**    | `/api/v1/reservas/{id}` | Obtener detalle de una reserva         |
| **POST**   | `/api/v1/reservas` | Crear una reserva       |
| **PUT**    | `/api/v1/reservas/{id}` | Modifica una reserva           |
